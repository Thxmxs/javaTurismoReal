...
private void mostrarComboBoxDepartamento(){
        ...
        dm.mostrarCmbxRegiones(cmBoxRegion);
    ...
    private void tablaDepartamentosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaDepartamentosMouseClicked
       dm.PasarDatosTablasACampos(tablaDepartamentos, txtIdDepartmaneto, txtDireccion, txtCosto,
               txtEstado, txtDescripcion, txtOrientacion, txtEstacionamiento, txtNumHabitaciones,
               txtNumBaños, txtNumEstacionamientos, cmBoxComuna, cmBoxProvincia, cmBoxRegion);
        ...
        try {
            ...
            ps = conexion.prepareStatement("select id_departamento,direccion,costo_departamento,estado_departamento,descripcion_estado_departamento,orientacion_departamento,estacionamiento,num_habitaciones,num_baño,num_estacionamiento from departamento where id=?");
            ps.setString(1, codigo);
            rs=ps.executeQuery();
            while (rs.next()) {
                txtIdDepartmaneto.setText(rs.getString("id_departamento"));
                txtDireccion.setText(rs.getString("direccion"));
                txtCosto.setText(rs.getString("costo_departamento"));
                txtEstado.setText(rs.getString("estado_departamento"));
                txtDescripcion.setText(rs.getString("descripcion_estado_departamento"));
                txtOrientacion.setText(rs.getString("orientacion_departamento"));
                txtEstacionamiento.setText((rs.getString("estacionamiento")));
                txtNumHabitaciones.setText((rs.getString("num_habitaciones")));
                txtNumBaños.setText(rs.getString("num_baño"));
                txtNumEstacionamientos.setText(rs.getString("num_estacionamientos"));
